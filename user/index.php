		 ...
		 <h1 class="page-header">Dashboard</h1>
		  <div class="row placeholders">
			...
			<img src="a1.jpg" width="200" height="200">
               <a href="assn.php"><span class="glyphicon glyphicon-list-alt"><h1>ASSIGNMENT</h1></a>
             </div>
            <div class="col-xs-6 col-sm-3 placeholder">
      		<img src="qs.jfif" width="200" height="200">  
               <a href="questionbank.php"><span class="glyphicon glyphicon-object-align-vertical"><h1>QUESTION BANK</h1></a>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
	      		<img src="ns.jfif" width="200" height="200"> 
                <a href="notes.php"><span class="glyphicon glyphicon-book"><h1>NOTES</h1></a>
             </div>
            <div class="col-xs-6 col-sm-3 placeholder">
               	<img src="rc.jfif" width="200" height="200">  
			      <a href="teacherremarks.php"><span class="glyphicon glyphicon-comment"><h1>	TEACHER REMARKS</h1></a>
            </div>
          </div>
<?php } ?>
