...
<table  style="display: table; border-collapse: collapse; border-spacing: 2px;    border-color: gray; border:3px solid black; border-collapse: collapse; margin-left:360px; margin-right: auto; margin-top: 50px; ">
  <tr>
  <th style="border: 3px solid black;border-collapse: collapse;padding: 10px; margin: auto;text-align: center;text-decoration: initial;text-transform: capitalize;border:1px solid black;"><b>Notes</b></th>
  </tr>
          <?php
          ...
          ?>
  <tr>
    <td style="border: 3px solid black;border-collapse: collapse;padding: 10px; margin: auto;text-align: center;text-decoration: initial;text-transform: capitalize;
      border:1px solid black;"><a href="notes/<?php $row["file"]?>"><?php echo $row["file"] ?></a></td>
  </tr>
  <?php 
    }
  ?>
