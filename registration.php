...
Female<input type="radio" name="gen" value="f"/>	
		...
		<tr>
			...
			<Td>Reading<input value="reading" type="checkbox" name="hob[]"/>Singing<input value="singin" type="checkbox" name="hob[]"/>		Playing<input value="playing" type="checkbox" name="hob[]"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<Td><select style="width:100px;float:left" name="yy" 						class="form-control" required>
